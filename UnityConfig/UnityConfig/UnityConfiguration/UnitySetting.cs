...
namespace UnityConfig.UnityConfiguration
{
    public class UnitySetting
    {
        ...
        {
            //vario
            this.LiftTreshold = SettingPropertyManager.CreateDouble100(title: Resources.PROPERTY_LiftTreshold_Title, name: "LiftTreshold", packetCode: "UNLT", formatLabelValue: "{0} m/s", defaultValue: 0.1m, minValue: 0m, maxValue: 10m, description: Resources.PROPERTY_LiftTreshold_Description);
            this.SinkTreshold = SettingPropertyManager.CreateDouble100(title: Resources.PROPERTY_SinkTreshold_Title, name: "SinkTreshold", packetCode: "UNST", formatLabelValue: "{0} m/s", defaultValue: 2.5m, minValue: 0m, maxValue: 10m, description: Resources.PROPERTY_SinkTreshold_Description);
            this.Sensitivity = SettingPropertyManager.CreateInt(title: Resources.PROPERTY_Sensitivity_Title, name: "Sensitivity", formatLabelValue: "{0} %", packetCode: "UNSEN", defaultValue: 50, minValue: 0, maxValue: 100, description: Resources.PROPERTY_Sensitivity_Description);
